      ...
      steps: [
        {
          ...
          content: 'Click this button or press <kbd>Option+Space</kbd> to start recording. Your audio will be transcribed in real-time!',
          position: 'bottom',
          beforeShow: async () => {
        ...
        },
        {
          ...
          content: 'Click the button again or press <kbd>Option+Space</kbd> to stop. Your session is automatically saved - no manual save needed!',
          position: 'bottom'
        }
      ]
    },
